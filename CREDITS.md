...
Sound effects in `src/assets/sfx/` are sourced from *The Complete RPG Creator
Bundle* (Humble Bundle, Aug–Sep 2026), all published via
[GameDev Market](https://www.gamedevmarket.net) under their
[Pro Licence](https://www.gamedevmarket.net/terms-conditions/#pro-licence)
...
`assets/candidates/`. His packs carry their own licence in addition to GameDev
Market's, which requires this credit. Not yet used in the shipped game; keep
this line if/when they are.
